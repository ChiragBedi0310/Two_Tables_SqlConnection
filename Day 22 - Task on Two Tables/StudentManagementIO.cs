...
namespace TaskOnSQLConnections
{
    class StudentManagementIO
    {
        ...
        public byte Menu()
        {
            ...
            Console.WriteLine("Press 2 to View All Details");
            Console.WriteLine("Press 3 to Update Student");
            Console.WriteLine("Press 4 to Delete Student");
            Console.WriteLine("Press 5 to Add Student Department");
            Console.WriteLine("Press 6 to Delete Department");
        ...
        public void AddDepartment()
        {
            try
            {
                ...
                Console.WriteLine("Enter Class Incharge's Name:");
                string manager = Console.ReadLine();
                departmentservice.AddDepartment(id, deptName, manager);
                Console.WriteLine("".PadLeft(15, '-'));
            }
            catch (Exception e)
            {
